...
CREATE TABLE IF NOT EXISTS `data` (
  ...
  `parental level of education` varchar(100) NOT NULL,
  `lunch` varchar(100) NOT NULL,
  `test preparation course` varchar(100) NOT NULL,
  `math score` int unsigned NOT NULL,
  `reading score` int unsigned NOT NULL,
  `writing score` int unsigned NOT NULL,
  PRIMARY KEY (`id`)
);
...
CREATE TABLE IF NOT EXISTS `users` (
  ...
  `is_active` bit(1) NOT NULL DEFAULT b'1',
  PRIMARY KEY (`id`),
  UNIQUE KEY `users_UN` (`email`,`is_active`)
);


INSERT INTO `data` (gender,`race/ethnicity`,`parental level of education`,lunch,`test preparation course`,`math score`,`reading score`,`writing score`) VALUES
